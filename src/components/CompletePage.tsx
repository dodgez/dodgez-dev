...
const STATUS_CONTENT_MAP = {
  canceled: {
    icon: ErrorIcon,
    iconColor: '#DF1B41',
    text: 'The transaction was canceled, please try again.',
  },
  default: {
    icon: ErrorIcon,
    iconColor: '#DF1B41',
...
export default function CompletePage() {
  ...
  return (
    <div id="payment-status">
          ...
          <table>
            <tbody>
              <tr>
                ...
                <td className="TableContent" id="intent-id">
                  {intentId}
                </td>
              </tr>
              <tr>
                <td className="TableLabel">status</td>
                <td className="TableContent" id="intent-status">
                  {status}
                </td>
              </tr>
            </tbody>
      ...
      <a href="/checkout" id="retry-button">
        Test another
      </a>
    </div>
  );
